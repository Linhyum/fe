...
import { decodeHTML, formatCurrency, formatShortCurrency } from '@/lib/utils'
...
export default function Statistics() {
   ...
   return (
      <div className='container p-6'>
         ...
         {isFetching ? (
            <div className=' mx-auto w-20 h-20 mt-20 border-8 border-blue-500 rounded-full animate-spin border-t-transparent'></div>
         ) : (
            <>
               {/* Thống kê tổng quan */}
                     ...
                     <CardContent className='p-6 flex items-center justify-between'>
                        <div>
                           ...
                           <p className='text-xs text-muted-foreground mt-1'>
                              +{statistics?.newUsersToday || 0} hôm nay
                           </p>
                        </div>
                  ...
                  <Card>
                     <CardContent className='p-6 flex items-center justify-between'>
                        <div>
                           ...
                           <p className='text-xs text-muted-foreground mt-1'>
                              +{statistics?.newOrdersToday || 0} hôm nay
                           </p>
                        </div>
                  ...
                  <Card>
                     <CardContent className='p-6 flex items-center justify-between'>
                        <div>
                           ...
                           <h2 className='text-3xl font-bold'>{formatShortCurrency(statistics?.totalRevenue || 0)}</h2>
                           <p className='text-xs text-muted-foreground mt-1'>
                              ...
                              <div className='flex flex-wrap gap-4 items-end'>
                                 ...
                                 <div className='space-y-2'>
                                    ...
                                    <DatePicker
                                       ...
                                       onChange={(date) => date && setRevenueEndDate(date)}
                                    />
                                 </div>
                              </div>
                           ...
                           <div className='mb-6 flex flex-wrap gap-4 items-end'>
                              ...
                              <div className='space-y-2'>
                                 ...
                                 <DatePicker
                                    ...
                                    onChange={(date) => date && setCategoryEndDate(date)}
                                 />
                              </div>
                           </div>
